...
comment on column public.wechat_web_claims.exposed_at is
  'Time the claim URL was first returned to the WeChat worker; the short claim TTL starts here rather than at QR activation.';
